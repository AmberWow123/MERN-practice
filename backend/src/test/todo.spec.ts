...
describe('Form test', () => {
    ...
    it('should get todo item after input', async () => {
        ...
        const response = await server.inject({
            ...
            payload: {
                name: 'clean my desk',
                description: 'should be done before lunch',
                status: false
            }
        })
        ...
        expect(res.todo.description).toBe('should be done before lunch')
        ...
        expect(res2.todos[0].description).toBe('should be done before lunch')
